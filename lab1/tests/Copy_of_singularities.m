...
J_07 = jacobian(T_07(1:3,3), [A1 A2 A3 A4 A5 A6]);

J_07_t = J_07';

det_jacobian = det(J_04);

det_j1 = det( [J_07_t(5,:) ; J_07_t(6,:) ; J_07_t(1,:) ] ) == 0;

det_j2 = det( [J_07_t(5,:) ; J_07_t(6,:) ; J_07_t(2,:) ] ) == 0;

det_j3 = det( [J_07_t(5,:) ; J_07_t(6,:) ; J_07_t(3,:) ] ) == 0;

det_j4 = det( [J_07_t(5,:) ; J_07_t(6,:) ; J_07_t(4,:) ] ) == 0;