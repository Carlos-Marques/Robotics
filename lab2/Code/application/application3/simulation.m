...
%     initialPose = [x_car(1), y_car(1), orientation, 0];
    ...
    for n=1:length(y_graph_min)-1
        ...
        if min(nonzeros(flags))~=1
            ...
            [TBFlag,t,carPose,u,e,E_remaining, car_polygon] = lowlevelController(hi,NSim,goalRadius,lookAhead,trajectory,timer,car_polygon,E_budget,energy_field,axis,time_field,initialPose,h1, speed_limit, slow_down, sd_time, P0);
