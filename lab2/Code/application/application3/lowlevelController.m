function [TBFlag,t,carPose,u,e,E_remaining, car_polygon] = lowlevelController(h,NSim,goalRadius,lookAhead,path,time,car_polygon,E_budget,energy_field,axis,time_field,initialPose,h1, speed_limit, slow_down, sd_time, P0)
%INPUT
%
%
%
